...
Lobster carapace length significantly differs in at least two sites in 2017 (F(4) = 3.424, $p$ = 0.0085, $\alpha$ = 0.05).
...
aqprop <-size_tidier %>%
  filter(SITE == "AQUE", 
         YEAR == "2017")
mean(aqprop$SIZE > 82.6)

caprop <-size_tidier %>%
  filter(SITE == "CARP", 
         YEAR == "2017")
mean(caprop$SIZE > 82.6)

moprop <-size_tidier %>%
  filter(SITE == "MOHK", 
         YEAR == "2017")
mean(moprop$SIZE > 82.6)
